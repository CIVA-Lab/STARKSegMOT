...
class Detector:
    def __init__(self, device):
        config_file = "/usr/mvl2/esdft/aot-sam-main/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = '/usr/mvl2/esdft/aot-sam-main/ckpt/groundingdino_swint_ogc.pth'
